...
module.exports = function MondoThemeModule(pb) {
     ...
     */
    MondoTheme.onInstall = function(cb) {
        cb(null, true);
    };
     ...
     * The result is ignored
     */
    MondoTheme.onUninstall = function(cb) {
        cb(null, true);
    };
     ...
     * The result is ignored
     */
    MondoTheme.onStartup = function(cb) {
        pb.AdminSubnavService.registerFor('plugin_settings', function(navKey, localization, data) {
            if(data.plugin.uid === 'mondo-theme') {
                return [
                    {
                        name: 'home_page_settings',
                        title: 'Home page settings',
                        icon: 'home',
                        href: '/admin/plugins/mondo-theme/settings/home_page'
                    }
                ];
            }
            return [];
     ...
     * The result is ignored
     */
    MondoTheme.onShutdown = function(cb) {
        cb(null, true);
    };
