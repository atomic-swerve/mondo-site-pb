...
module.exports = function IndexModule(pb) {
    ...
    /**
     * Error The home page controller of the mondo-theme theme.
     * @class Error
     * @author Blake Callens <blake@pencilblue.org>
     * @copyright 2014 PencilBlue, LLC.  All Rights Reserved
     */
    function Error() {}
    util.inherits(Error, pb.BaseController);

    Error.prototype.init = function (props, cb) {
        var self = this;
     ...
     *  makes no guarantees.
     */
    Error.prototype.render = function(cb) {
        var self = this;
            ...
            TopMenu.getBootstrapNav(navigation, accountButtons, function(navigation, accountButtons) {
                ...
                pluginService.getSettings('mondo-theme', function(err, mondoSettings) {
                    ...
                    self.ts.registerLocal('page_name', function(flag, cb) {
                        self.getContentSpecificPageName(null, cb);
                    });
                    self.ts.load('landing_page', function(err, template) {
                        ...
                        self.siteQueryService.q('mondo-theme_theme_settings', opts, function(err, settings) {
                            if (util.isError(err)) {
    ...
    Error.prototype.getContentSpecificPageName = function(content, cb) {
        if (!content) {
