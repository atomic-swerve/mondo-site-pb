...
module.exports = function HomePageSettingsModule(pb) {
    ...
    var SUB_NAV_KEY = 'mondo-theme_home_page_settings';

    /**
     * Settings for the display of home page content in the mondo-theme theme
    ...
    HomePageSettings.prototype.render = function(cb) {
        ...
        self.siteQueryService.q('mondo_theme_settings', opts, function(err, homePageSettings) {
        ...
        return [
            {
                ...
                icon: 'chevron-left',
                href: '/admin/plugins/mondo-theme/settings'
            }
        ];
    };
    ...
    HomePageSettings.getRoutes = function(cb) {
        var routes = [
            {
                method: 'get',
                path: '/admin/plugins/mondo-theme/settings/home_page',
                auth_required: true,
