...
module.exports = function SaveHomePageSettingsModule(pb) {
    ...
    /**
     *  Saves settings for the display of home page content in the mondo-theme theme
        ...
        this.getJSONPostParams(function(err, post) {
            ...
            self.siteQueryService.q('mondo_theme_settings', opts, function(err, homePageSettings) {
                ...
                if(homePageSettings.length > 0) {
                    ...
                    homePageSettings = pb.DocumentCreator.create('mondo_theme_settings', post);
    ...
    SaveHomePageSettings.getRoutes = function(cb) {
        var routes = [
            {
                method: 'post',
                path: '/actions/admin/plugins/settings/mondo-theme/home_page',
                auth_required: true,
